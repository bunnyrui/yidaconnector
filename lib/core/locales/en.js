...
Examples:
  ...
  openyida create-process APP_XXX "Order Form" fields.json process-def.json
...
`,
  ...
  update: {
    ...
    already_latest: '✅ Already up to date (v{0}), no update needed',
    found_new_version: '📦 New version available: {0} (current: {1})',
    installing: '⏳ Updating openyida...',
    success: '✅ Update successful! Current version: {0}',
    install_failed: '❌ Update failed: {0}',
    manual_hint: '   Please try manually: npm install -g openyida@latest',
  },
...
Options:
  ...
  create_process: {
    ...
    example: 'Example: openyida create-process "APP_XXX" "Order Form" fields.json process-definition.json',
