...
module.exports = {
  ...
  help: {
    ...
    cmd_bridge: 'Iniciar servicio local YidaConnector web bridge',
    ...
    cmd_batch: 'Ejecutar comandos YidaConnector en lote',
  ...
  cli: {
    ...
    integration_help_hint: 'Use yidaconnector integration --help para ver los subcomandos disponibles',
    integration_list_usage: 'Uso: yidaconnector integration list <appType> [--form-uuid <uuid>] [--status y|n] [--key <kw>] [--page <n>] [--size <n>] [--json]',
    integration_list_example: 'Ejemplo: yidaconnector integration list APP_XXX --form-uuid FORM-XXX --json',
    integration_enable_usage: 'Uso: yidaconnector integration enable <appType> <formUuid> <processCode>',
    integration_enable_example: 'Ejemplo: yidaconnector integration enable APP_XXX FORM-XXX LPROC-XXX',
    integration_disable_usage: 'Uso: yidaconnector integration disable <appType> <formUuid> <processCode>',
    integration_disable_example: 'Ejemplo: yidaconnector integration disable APP_XXX FORM-XXX LPROC-XXX',
    compile_usage: 'Uso: yidaconnector compile <sourceFile>',
    compile_example: 'Ejemplo: yidaconnector compile pages/src/home.oyd.jsx',
  ...
  // ── lib/env.js ─────────────────────────────────────
  env: {
    title: '  yidaconnector env - Detección del entorno de herramienta IA',
  ...
  // ── lib/create-app.js ───────────────────────────────
  create_app: {
    usage: 'Uso: yidaconnector create-app "<nombre de la app>" o yidaconnector create-app --name "<nombre de la app>" [--desc "..."] [--theme deepBlue]',
    example: 'Ejemplo: yidaconnector create-app --name "Mi App" --desc "Descripcion de la app" --theme deepBlue',
  ...
  // ── lib/create-form.js ──────────────────────────────
  create_form: {
    usage: 'Uso: yidaconnector create-form <appType> <nombre de página> [JSON del esquema]',
  ...
  // ── lib/create-page.js ──────────────────────────────
  create_page: {
    usage: 'Uso: yidaconnector create-page <appType> <nombre de página> [--mode dashboard]',
    example: 'Ejemplo: yidaconnector create-page APP_XXX "Dashboard" --mode dashboard',
  ...
  check_update: {
    ...
    update_cmd: '   Actualizar: npm install -g yidaconnector',
  ...
  update: {
    ...
    manual_hint: 'Intente manualmente: npm install -g yidaconnector@latest',
    ...
    done_hint: 'Ejecute yidaconnector --version para confirmar la nueva versión',
  },
  ...
  // ── lib/import-app.js ───────────────────────────────
  import_app: {
    usage: 'Uso: yidaconnector import-app <ruta del archivo>',
  ...
  // ── lib/copy.js ────────────────────────────────────
  copy: {
    title: '  yidaconnector copy - Inicializar directorio de trabajo Yida',
    package_root: '\n📦 Raíz del paquete: {0}',
    ...
    no_package: '\n❌ Directorio del paquete yidaconnector no encontrado',
    no_package_hint1: '   Asegúrese de que yidaconnector esté instalado globalmente:',
  ...
  publish: {
    ...
    usage: 'Uso: yidaconnector publish <archivoFuente> <appType> <formUuid> [--health-check]',
    example: 'Ejemplo: yidaconnector publish pages/src/xxx.js APP_XXX FORM-XXX --health-check',
  },
  ...
  postinstall: {
    welcome_title: '  🎉 ¡Bienvenido a YidaConnector!                                   ',
    install_success: '  ✅ ¡Instalación completada! {0} La herramienta de desarrollo IA Yida está lista.',
    update_success: '  ✅ ¡Actualización completada! {0} YidaConnector ha sido actualizado a la última versión.',
    ...
    step3: '  {0}Step 3{1}  La IA ejecuta automáticamente los comandos yidaconnector',
    step4: '  {0}Step 4{1}  Obtén el enlace de tu app Yida 🎉',
    commands_title: '  ⚡ Comandos rápidos',
    cmd_env: '  {0}yidaconnector env{1}      {2}# Detectar entorno de herramienta IA y estado de sesión{3}',
    cmd_login: '  {0}yidaconnector login{1}    {2}# Iniciar sesión en Yida{3}',
    cmd_help: '  {0}yidaconnector --help{1}   {2}# Ver todos los comandos{3}',
    footer1: '  📚 Documentación: https://github.com/bunnyrui/yidaconnector',
    footer2: '  💬 Comunidad: Únete a la comunidad YidaConnector en DingTalk',
  },
  ...
  cdn: {
    ...
    config_usage: 'Uso: yidaconnector cdn-config [opciones]',
    ...
    run_config_init: '   Por favor ejecute primero: yidaconnector cdn-config --init',
  ...
  flashNote: {
    toPrd: {
      ...
      help_usage: 'Uso: yidaconnector flash-to-prd --file <ruta> [--name <nombre-proyecto>]',
      help_usage2: '     yidaconnector flash-to-prd --name <nombre-proyecto>  (leer desde stdin)',
      ...
      help_example1: '  yidaconnector flash-to-prd --file ./meeting-notes.txt --name "Inspeccion de equipos"',
      help_example2: '  cat meeting.txt | yidaconnector flash-to-prd --name "Inspeccion de equipos"',
